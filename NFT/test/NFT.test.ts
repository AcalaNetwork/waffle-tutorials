...
describe('NFT', () => {
  ...
  describe('Deployment', () => {
    ...
    it('should revert when trying to get the balance of the 0x0 address', async () => {
      await expect(instance.balanceOf(NULL_ADDRESS)).to.revertedWith('ERC721: balance query for the zero address');
    });
  });
  ...
  describe('Operation', () => {
    describe('minting', () => {
      it('should emit Transfer event', async () => {
        await expect(instance.connect(deployer).mintNFT(userAddress, 'testToken'))
